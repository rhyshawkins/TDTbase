...
#define G3 -H0
  ...
  for (i = WIDTH - 2; i < WIDTH + 2; i ++) {
    printf("%2d %2d %10.6f\n", i, wavelet_boundary_periodic(i, WIDTH), data[i]);
  }

  printf("%10.6f\n",
	 H0 * data[30] + H1*data[31] + H2*data[30] + H3*data[29]);
  ...
  ck_assert(daub4_lift_forward1d_daub4_step(data, 
					    WIDTH,
					    1, 
					    work) >= 0);
...
START_TEST (test_daub4_1d_constant)
{
  ...
  ck_assert(daub4_lift_forward1d_daub4(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
  ...
  ck_assert(daub4_lift_inverse1d_daub4(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
...
START_TEST (test_daub4_1d_sinusoid)
{
  ...
  ck_assert(daub4_lift_forward1d_daub4(recon, 
				       WIDTH,
				       1, 
				       work) >= 0);
  ...
  ck_assert(daub4_lift_inverse1d_daub4(recon, 
				       WIDTH,
				       1,
				       work) >= 0);
...
START_TEST (test_daub4_2d_constant)
{
  ...
  ck_assert(daub4_lift_forward2d_daub4(data, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       work) >= 0);
  ...
  ck_assert(daub4_lift_inverse2d_daub4(data, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       work) >= 0);
...
START_TEST (test_daub4_2d_sinusoid)
{
  ...
  ck_assert(daub4_lift_forward2d_daub4(recon, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       work) >= 0);
  ...
  ck_assert(daub4_lift_inverse2d_daub4(recon, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       work) >= 0);
...
START_TEST (test_daub4_3d_sinusoid)
{
   ...
   */
  ck_assert(daub4_lift_forward3d_daub4_step(recon,
					    WIDTH,
					    WIDTH,
					    WIDTH,
					    WIDTH,
  ...
  ck_assert(daub4_lift_inverse3d_daub4_step(recon, 
					    WIDTH,
					    WIDTH,
					    WIDTH, 
					    WIDTH,
  ...
  ck_assert(daub4_lift_forward3d_daub4(recon, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       WIDTH,
  ...
  ck_assert(daub4_lift_inverse3d_daub4(recon, 
				       WIDTH,
				       WIDTH,
				       WIDTH, 
				       WIDTH,
