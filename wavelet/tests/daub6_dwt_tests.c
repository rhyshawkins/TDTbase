...
START_TEST (test_daub6_1d_simple_step)
{
#define OVERLAP 8
  double data[WIDTH + 8];
...
#define H0  0.235233603892081840 
#define H1  0.570558457915721800 
#define H2  0.325182500263116240 
#define H3 -0.095467207784163680 
#define H4 -0.060416104155198096 
#define H5  0.024908749868441864 
...
#define G5 -H0
  ...
  ck_assert(daub6_dwt_forward1d_daub6_step(data, 
					   WIDTH,
					   1, 
					   work) >= 0);
...
START_TEST (test_daub6_1d_constant_step)
{
  double data[WIDTH];
  double work[WIDTH];
  int i;
...
START_TEST (test_daub6_1d_sinusoid_step)
{
  double data[WIDTH];
  double recon[WIDTH];
  double work[WIDTH];
  ...
  ck_assert(daub6_dwt_forward1d_daub6_step(recon, 
					   WIDTH,
					   1, 
					   work) >= 0);
  ...
  ck_assert(daub6_dwt_inverse1d_daub6_step(recon, 
					   WIDTH,
					   1, 
					   work) >= 0);
...
START_TEST (test_daub6_1d_constant)
{
  double data[WIDTH];
  double work[WIDTH];
  int i;
  ...
  ck_assert(daub6_dwt_forward1d_daub6(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
  ...
  ck_assert(daub6_dwt_inverse1d_daub6(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
...
START_TEST (test_daub6_1d_sinusoid)
{
  double data[WIDTH];
  double recon[WIDTH];
  double work[WIDTH];
  ...
  ck_assert(daub6_dwt_forward1d_daub6(recon, 
				      WIDTH,
				      1, 
				      work) >= 0);
  ...
  ck_assert(daub6_dwt_inverse1d_daub6(recon, 
				      WIDTH,
				      1,
				      work) >= 0);
...
START_TEST (test_daub6_2d_constant)
{
  ...
  ck_assert(daub6_dwt_forward2d_daub6(data, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
  ...
  ck_assert(daub6_dwt_inverse2d_daub6(data, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
...
START_TEST (test_daub6_2d_sinusoid)
{
  double data[WIDTH * WIDTH];
  ...
  ck_assert(daub6_dwt_forward2d_daub6(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
  ...
  ck_assert(daub6_dwt_inverse2d_daub6(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
...
START_TEST (test_daub6_2d_constant_nonsquare1)
{
...
START_TEST (test_daub6_2d_constant_nonsquare2)
{
...
START_TEST (test_daub6_2d_sinusoid_nonsquare1)
{
  double data[NS1_WIDTH * NS1_HEIGHT];
...
START_TEST (test_daub6_2d_sinusoid_nonsquare2)
{
  double data[NS2_WIDTH * NS2_HEIGHT];
...
START_TEST (test_daub6_3d_sinusoid)
{
   ...
   */
  ck_assert(daub6_dwt_forward3d_daub6_step(recon,
					   WIDTH,
					   WIDTH,
					   WIDTH,
					   WIDTH,
  ...
  ck_assert(daub6_dwt_inverse3d_daub6_step(recon, 
					   WIDTH,
					   WIDTH,
					   WIDTH, 
					   WIDTH,
  ...
  ck_assert(daub6_dwt_forward3d_daub6(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      WIDTH,
  ...
  ck_assert(daub6_dwt_inverse3d_daub6(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      WIDTH,
...
START_TEST (test_daub6_3d_sinusoid_nonsquare1)
{
...
START_TEST (test_daub6_3d_sinusoid_nonsquare2)
{
...
daub6_suite (void)
{
  Suite *s = suite_create ("DAUB6");

  /* Core test case */
  TCase *tc_core = tcase_create ("Core");

  tcase_add_test (tc_core, test_daub6_1d_simple_step);
  
  tcase_add_test (tc_core, test_daub6_1d_constant_step);
  tcase_add_test (tc_core, test_daub6_1d_sinusoid_step);

  tcase_add_test (tc_core, test_daub6_1d_constant);
  tcase_add_test (tc_core, test_daub6_1d_sinusoid);
  
  tcase_add_test (tc_core, test_daub6_2d_constant);
  tcase_add_test (tc_core, test_daub6_2d_sinusoid);
  tcase_add_test (tc_core, test_daub6_2d_constant_nonsquare1);
  tcase_add_test (tc_core, test_daub6_2d_constant_nonsquare2);
  tcase_add_test (tc_core, test_daub6_2d_sinusoid_nonsquare1);
  tcase_add_test (tc_core, test_daub6_2d_sinusoid_nonsquare2);
  tcase_add_test (tc_core, test_daub6_3d_sinusoid);
  tcase_add_test (tc_core, test_daub6_3d_sinusoid_nonsquare1);
  tcase_add_test (tc_core, test_daub6_3d_sinusoid_nonsquare2);
