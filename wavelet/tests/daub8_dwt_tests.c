...
START_TEST (test_daub8_1d_simple_step)
{
#define OVERLAP 8
  double data[WIDTH + 8];
...
#define H0  0.162901714025649180 
#define H1  0.505472857545914400 
#define H2  0.446100069123379800 
#define H3 -0.019787513117822320 
#define H4 -0.132253583684519870 
#define H5  0.021808150237088625 
#define H6  0.023251800535490877 
#define H7 -0.007493494665180735  
...
#define G7 -H0
  ...
  ck_assert(daub8_dwt_forward1d_daub8_step(data, 
					   WIDTH,
					   1, 
					   work) >= 0);
...
START_TEST (test_daub8_1d_constant_step)
{
  double data[WIDTH];
  double work[WIDTH];
  int i;
...
START_TEST (test_daub8_1d_sinusoid_step)
{
  double data[WIDTH];
  double recon[WIDTH];
  double work[WIDTH];
  ...
  ck_assert(daub8_dwt_forward1d_daub8_step(recon, 
					   WIDTH,
					   1, 
					   work) >= 0);
  ...
  ck_assert(daub8_dwt_inverse1d_daub8_step(recon, 
					   WIDTH,
					   1, 
					   work) >= 0);
...
START_TEST (test_daub8_1d_constant)
{
  double data[WIDTH];
  double work[WIDTH];
  int i;
  ...
  ck_assert(daub8_dwt_forward1d_daub8(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
  ...
  ck_assert(daub8_dwt_inverse1d_daub8(data, 
				       WIDTH,
				       1, 
				       work) >= 0);
...
START_TEST (test_daub8_1d_sinusoid)
{
  double data[WIDTH];
  double recon[WIDTH];
  double work[WIDTH];
  ...
  ck_assert(daub8_dwt_forward1d_daub8(recon, 
				      WIDTH,
				      1, 
				      work) >= 0);
  ...
  ck_assert(daub8_dwt_inverse1d_daub8(recon, 
				      WIDTH,
				      1,
				      work) >= 0);
...
START_TEST (test_daub8_2d_constant)
{
  ...
  ck_assert(daub8_dwt_forward2d_daub8(data, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
  ...
  ck_assert(daub8_dwt_inverse2d_daub8(data, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
...
START_TEST (test_daub8_2d_sinusoid)
{
  double data[WIDTH * WIDTH];
  ...
  ck_assert(daub8_dwt_forward2d_daub8(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
  ...
  ck_assert(daub8_dwt_inverse2d_daub8(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      work,
...
START_TEST (test_daub8_2d_constant_nonsquare1)
{
...
START_TEST (test_daub8_2d_constant_nonsquare2)
{
...
START_TEST (test_daub8_2d_sinusoid_nonsquare1)
{
  double data[NS1_WIDTH * NS1_HEIGHT];
...
START_TEST (test_daub8_2d_sinusoid_nonsquare2)
{
  double data[NS2_WIDTH * NS2_HEIGHT];
...
START_TEST (test_daub8_3d_sinusoid)
{
   ...
   */
  ck_assert(daub8_dwt_forward3d_daub8_step(recon,
					    WIDTH,
					    WIDTH,
					    WIDTH,
					    WIDTH,
  ...
  ck_assert(daub8_dwt_inverse3d_daub8_step(recon, 
					    WIDTH,
					    WIDTH,
					    WIDTH, 
					    WIDTH,
  ...
  ck_assert(daub8_dwt_forward3d_daub8(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      WIDTH,
  ...
  ck_assert(daub8_dwt_inverse3d_daub8(recon, 
				      WIDTH,
				      WIDTH,
				      WIDTH, 
				      WIDTH,
...
START_TEST (test_daub8_3d_sinusoid_nonsquare1)
{
...
START_TEST (test_daub8_3d_sinusoid_nonsquare2)
{
...
daub8_suite (void)
{
  Suite *s = suite_create ("DAUB8");

  /* Core test case */
  TCase *tc_core = tcase_create ("Core");

  tcase_add_test (tc_core, test_daub8_1d_simple_step);
  
  tcase_add_test (tc_core, test_daub8_1d_constant_step);
  tcase_add_test (tc_core, test_daub8_1d_sinusoid_step);

  tcase_add_test (tc_core, test_daub8_1d_constant);
  tcase_add_test (tc_core, test_daub8_1d_sinusoid);
  
  tcase_add_test (tc_core, test_daub8_2d_constant);
  tcase_add_test (tc_core, test_daub8_2d_sinusoid);
  tcase_add_test (tc_core, test_daub8_2d_constant_nonsquare1);
  tcase_add_test (tc_core, test_daub8_2d_constant_nonsquare2);
  tcase_add_test (tc_core, test_daub8_2d_sinusoid_nonsquare1);
  tcase_add_test (tc_core, test_daub8_2d_sinusoid_nonsquare2);
  tcase_add_test (tc_core, test_daub8_3d_sinusoid);
  tcase_add_test (tc_core, test_daub8_3d_sinusoid_nonsquare1);
  tcase_add_test (tc_core, test_daub8_3d_sinusoid_nonsquare2);
